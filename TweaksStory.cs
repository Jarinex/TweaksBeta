...
namespace TweakMod
{
    class StoryTweaks
    {
        ...
        static void updateKoboldTeacher()
        {
            ...
            var spell_list = newsorcererLevels.SelectSpells.AddToArray(haste,acidarrow, blur);
            ...
            var spell_list2 = newsorcererLevels2.Spells.AddToArray(haste, acidarrow,blur);
         ...
         // var spell_list3 = newsorcererLevels3.Spells.RemoveFromArray(magicmissle);
          ...
          //  KoboldTeacherSpellList.ReplaceComponent(sorcererLevels3, newsorcererLevels3);
            ...
            var magicmissleaiaction = library.CopyAndAdd<BlueprintAiCastSpell>("e689225185e99d3469052d9cce20316d", "MagicMissileAiAction", ""); 
            var ai_action2 = library.CopyAndAdd<BlueprintAiCastSpell>("c52c9c1d503180e44aebf198445d1845", "HasteAiAction", "");


            
            var brain = KoboldTeacherBrain;
            brain.Actions = brain.Actions.RemoveFromArray(magicmissleaiaction);
            brain.Actions = brain.Actions.AddToArray(AiActions.magicmissledelay, ai_action2, AiActions.acidarrowdelay, AiActions.blur_first);
